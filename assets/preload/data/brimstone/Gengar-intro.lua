...
upoffsets = {'-5', '0'} -- I recommend you have your idle offset at 0
idleoffsets = {'0', '0'}

-- change all of these to the name of the animation in your character's xml file
idle_xml_name = 'gengar entrance'
up_xml_name = 'gengar entrance'
...
name_of_character_xml = 'enter_gengar'
name_of_character = 'gengar-intro'
